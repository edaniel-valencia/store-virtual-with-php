...
class RegistroModel extends Query{
    ...
    $apellido,$direccion,$ciudad,$cod,$pais,$telefono,$envio, $id_usuario, $comprobante = null){
        $sql = "INSERT INTO ventas (transaccion, total, nombre,
        apellido,direccion,ciudad,cod,pais,telefono,envio, id_usuario, comprobante) VALUES (?,?,?,?,?,?,?,?,?,?,?,?)";
        return $this->insertar($sql, [$transaccion, $total, $nombre,
        $apellido,$direccion,$ciudad,$cod,$pais,$telefono,$envio, $id_usuario, $comprobante]);
    }
