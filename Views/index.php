                ...
                <div class="col-lg-3 col-md-4 col-sm-6 mix cat_<?php echo $producto['id_categoria']; ?> fresh-meat">
                    <div class="featured__item">
                        ...
                        <div class="featured__item__text">
                            <h6><a href="<?php echo urlProducto($producto['id'], $producto['nombre']); ?>"><?php echo $producto['nombre']; ?></a></h6>
                ...
                <div class="latest-product__text">
                    ...
                    <div class="latest-product__slider owl-carousel">
                        ...
                        foreach ($productos as $producto) {
                            ...
                            echo '<a href="' . urlProducto($producto['id'], $producto['nombre']) . '" class="latest-product__item">';
