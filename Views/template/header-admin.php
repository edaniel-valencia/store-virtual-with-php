...
<head>
    ...
    <link rel="shortcut icon" href="<?php echo BASE_URL; ?>public/img/logo-adavam.png">
    ...
    <link href="<?php echo asset('public/admin/css/custom-theme-admin.css'); ?>" rel="stylesheet" type="text/css">
...
<body class="fixed-left">
    ...
    <!-- Loader -->
    <div id="preloader">
        <img src="<?php echo BASE_URL; ?>public/img/logo-adavam.png" alt="ADAVAM" class="admin-preloader__logo">
        <div id="status">
            <div class="spinner">
                <div class="rect1"></div>
                <div class="rect2"></div>
                ...
                <div class="topbar">
                    ...
                    <div class="topbar-left	d-none d-lg-block">
                        <div class="text-center">
                            <a href="<?php echo BASE_URL; ?>" class="logo"><img src="<?php echo BASE_URL; ?>public/img/logo-adavam.png" height="22" alt="ADAVAM"></a>
                        </div>
                    </div>
                    ...
                    <nav class="navbar-custom">
                        ...
                        <ul class="list-inline float-right mb-0">
                            ...
                            <li class="list-inline-item">
                                <button type="button" class="admin-theme-toggle" id="admin-theme-toggle" aria-label="Cambiar tema" title="Cambiar tema">
                            ...
                            <li class="list-inline-item dropdown notification-list nav-user">
                                <a class="nav-link dropdown-toggle arrow-none waves-effect" data-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                                    ...
                                    <div class="d-none d-md-inline-block ml-2 text-left" style="vertical-align: middle; line-height: 1.2;">
                                        <span class="d-block admin-user-name" style="font-weight: 700; font-size: 14px; color: #333; margin-bottom: 2px;"><?php echo !empty($_SESSION['nombre_usuario']) ? $_SESSION['nombre_usuario'] : 'Usuario'; ?> <i class="mdi mdi-chevron-down" style="font-size: 12px;"></i></span>
                                        <small class="d-block admin-user-email" style="font-size: 11.5px; color: #888; font-weight: 500;"><?php echo $_SESSION['email']; ?></small>
                                    </div>
                                </a>
