...
INSERT INTO `configuracion` (`id`, `nombre`, `telefono`, `correo`, `whatsapp`, `direccion`, `host_smtp`, `user_smtp`, `pass_smtp`, `puerto_smtp`) VALUES
	(1, 'SISTEMAS', '0098098098', 'edanielvalenciam@gmail.com', '593962589397', 'peru', 'smtp.gmail.com', 'edanielvalenciam@gmail.com', 'ikhnyjislfpyzhgj', 465);
...
INSERT INTO `usuarios` (`id`, `correo`, `nombre`, `apellido`, `clave`, `direccion`, `tipo`, `perfil`, `verify`, `token`, `estado`) VALUES
	(1, 'edanielvalenciam@gmail.com', 'admin', 'ADMINISTRADOR', '$2y$10$YJPEpg7HtOh4dkGwyi2HeeZokS6oJcwi4ttaav/pSDecXaXyuFIGi', 'PERÚ', 1, NULL, 0, NULL, 1),
